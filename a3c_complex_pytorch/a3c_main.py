...
parser.add_argument('--load', type=str, default="./Asset/model/saved_2/saved_model",
...
parser.add_argument('--app-location', type=str, default='../Apps/kobuki_c4/kobuki_c4',
                    help='location of appilication')
parser.add_argument('--model-location', type=str, default='./Asset/model/saved_3/saved_model',
                    help='location of model')
parser.add_argument('--vedio-location', type=str, default='./Asset/video',
                    help='location of appilication')
...
if __name__ == '__main__':
    ...
    env = env_wrapper(args.app_location, idx=-1, base=240)
